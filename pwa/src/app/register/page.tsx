...
function RegisterForm() {
  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!loginRes.ok) throw new Error("Inscription réussie mais connexion impossible");
      ...
      const message = e instanceof Error ? e.message : "Impossible de créer le compte";
      setError(message);
    } finally {
      setLoading(false);
    }
  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center overflow-hidden bg-gradient-to-br from-black via-slate-950 to-black p-4">
      ...
      <div className="w-full max-w-md relative">
        <GlassCard>
          <AuthHeader title="Bienvenue" subtitle="Veuillez créer votre compte" />
